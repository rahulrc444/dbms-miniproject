...
if(isset($_GET["generate_bill"])){
  ...
  $obj_pdf -> SetTitle("Earth Medical Bill");
...
.company-details {
    ...
    <div class="company-details">
        <h2>Earth Medical </h2>
        <p>Earth Group, Udupi, 560055 Opp. KS Mall</p>
        <p>email: info@Earth.com contact: +91 999999999</p>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> Earth Patient's Portal</a>
