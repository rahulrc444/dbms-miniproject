...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> Earth Admin Portal</a>
...
function checklen()
{
  ...
  <style >
    ...
    background: -webkit-linear-gradient(to right, #210084, #e0cdff);  /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to right, #210084, #e0cdff); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
}
...
.list-group-item.active {
    ...
    background: linear-gradient(to right, #210084,  #e0cdff);
    border-color: #c3c3c3;
}
.text-primary {
...
.btn-primary:hover {
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family: 'IBM Plex Sans', sans-serif;"> Hello , ADMINISTRATOR </h3>
        ...
        <div class="container-fluid container-fullw bg-white" >
              <div class="row">
               <div class="col-sm-4">
                ...
                <div class="col-sm-4" style="left:68%;margin-top: -17%">
                  <div class="panel panel-white no-radius text-center">
                     <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-cog fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Update Patient</h4>
                      
                      <p class="cl-effect-1">
                        <a href="#app-hist" onclick="clickDiv('#list-update-list')">
                          Update Patient
                        </a>
                      </p>
                    </div> 
