<html>
<head>
	<title>Earth Medical ,Mangaluru</title>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 5px;margin-left:-60px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-hospital-o" aria-hidden="true" ></i>&nbsp Earth Medical ,Mangaluru</h4></a>
...
<div class="container register" style="font-family:Verdana,Comic sans MS, 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="images/logo12.png" alt="logo" style="width:150px;height:150px;"/>
                        <h3 >Welcome</h3>
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="index1.php" color="white"><i aria-hidden="true" ></i>Already have an account? Login Now</a>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="tel" minlength="10" maxlength="10" name="contact" class="form-control" placeholder="Contact *"  pattern="[0-9]{10}" required/>
                                        </div>
                                        <div class="form-group">
