...
<html lang="en">
  ...
  <body style="background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-hospital-o" aria-hidden="true"></i>&nbsp Earth Medical,Mangluru</h4></a>
    ...
    animation: mover 1s infinite alternate;">
          <img src="images/logo12.png" alt="" style="width: 30%;padding-left: 40px;margin-top: 150px;margin-left: 45px;margin-bottom:15px">
      </div>

      <div style="color: white;">
            <h4 style="font-family: 'IBM Plex Sans', sans-serif;">Your Health, Our Concern</h4>
          </div>
          ...
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              ...
              <form class="form-group" method="POST" action="func.php">
                ...
                <div class="row">
                 <div class="col-md-4"  style="padding-left: 190px;margin-top: 10%">
                    <center><input type="submit" id="inputbtn" name="patsub" value="Login" class="btn btn-success"></center></div>           
                  <div class="col-md-8" style="margin-top: 10%">
                    <a href="index.php" class="btn btn-primary" style="margin-top: -3%;margin-left: 50%">Back</a></div> 
                </div>
              </form>
            </center>
            </div>
