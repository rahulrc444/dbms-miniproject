...
if(isset($_POST['prescribe']) && isset($_POST['pid']) && isset($_POST['ID']) && isset($_POST['appdate']) && isset($_POST['apptime']) && isset($_POST['lname']) && isset($_POST['fname'])){
  ...
  $prescription = $_POST['prescription'];
    ...
    $query = "UPDATE prestb SET disease='$disease', allergy='$allergy', prescription='$prescription' WHERE ID='$ID'";
    $result = mysqli_query($con, $query);

  if($result){
    echo("<script>alert('Prescription Updated Successfully.');
...
<html lang="en">
  ...
  <title>Sanjeevani ,Mangaluru</title>
    ...
    <link href="https://fonts.googleapis.com/css?family=IBM+Plex+Sans&display=swap" rel="stylesheet">
      ...
      <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> Sanjeevani</a>
  ...
  <style >
    .bg-primary {
      background: #F0F2F0; 
    background: -webkit-linear-gradient(to right, #210084, #e0cdff);  
...
<body style="padding-top:50px;">
   ...
   <div class="tab-pane" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
        <form class="form-group" name="prescribeform" method="post" action="updateprescription.php">
        
          <div class="row">
            <div class="container">
            <div class="form-group">
            <input type="number" class="form-control"  placeholder="AID *" name="ID" required readonly/>
            ...
            document.getElementsByName("ID")[0].value = id;
              ...
              <div class="form-group">
                ...
                <textarea id="prescription"class="form-control" rows ="5" name="prescription" required></textarea>
                      ...
                      <br><br>
                  <input type="submit" name="prescribe" value="Update" class="btn btn-primary" style="margin-left: 40pc;">
            </div>
          </div>
